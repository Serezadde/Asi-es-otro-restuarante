...
<body>
    <div class="container">
        <h2>Añadir comandas a pedidos:</h2>
                ...
                <tbody>
                    <?php foreach ($resultado as $datos) { ?>
                        <tr>
                            ...
                            <td><a href="../../../vista/Pedidos/anadir_comanda.php?id_pedido=<?= htmlspecialchars($datos->id_pedido) ?>" class="btn btn-primary">Seleccionar <i class="fas fa-pen-to-square"></i></a></td>
